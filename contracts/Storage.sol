...
/// @title Storage layout exploration contract
/// @notice Demonstrates Solidity storage slots for various data types.
contract Storage {
  ...
  /// @notice Initialize example mappings and arrays with sample data.
  constructor() {
    cc.push(1); // 0
    cc.push(10); // 1
    cc.push(100); // 2
